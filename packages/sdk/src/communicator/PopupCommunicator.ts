import { standardErrors } from "../errors/index";
import { LIB_VERSION } from "../version";

import type { Message, MessageID } from "../client-gateway/message";
import type { Communicator } from "./index";
...
export class PopupCommunicator implements Communicator {
  ...
  waitForPopupLoaded = async (): Promise<Window> => {
    ...
    this.onMessage<PopupConfigMessage>(
