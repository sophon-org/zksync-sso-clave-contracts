...
const buttonUI = computed(() => {
  let base
    = "relative inline-flex items-center justify-center rounded-zk border border-transparent px-8 py-2 align-middle leading-3 focus:outline-none focus:ring-4 focus:ring-primary-400 focus:ring-opacity-50 dark:focus:ring-blue-800 dark:focus:ring-opacity-80 disabled:cursor-not-allowed";
...
const types = {
  primary:
    "bg-neutral-950 text-neutral-100 hover:bg-neutral-800 hover:text-white focus:bg-neutral-800 active:bg-neutral-950 active:text-neutral-200 disabled:bg-neutral-700 disabled:text-neutral-400 dark:bg-blue-700 dark:text-neutral-100 dark:hover:bg-blue-600 dark:hover:text-neutral-200 dark:focus:bg-blue-600 dark:active:bg-blue-800 dark:active:text-neutral-500 dark:disabled:hover:bg-neutral-700 dark:disabled:hover:text-neutral-400",
  secondary:
